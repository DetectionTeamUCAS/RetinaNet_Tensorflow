...
from libs.detection_oprations.anchor_target_layer_without_boxweight_batch import anchor_target_layer
...
class DetectionNetwork(object):
    ...
    def build_whole_detection_network(self, input_img_batch, gtboxes_batch):
        ...
        with tf.variable_scope('postprocess_detctions'):
            boxes, scores, category = postprocess_detctions(rpn_bbox_pred=rpn_box_pred[0, :, :],
